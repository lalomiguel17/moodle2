...
/**
 * Strings for component 'auth_saml', language 'es_mx', version '3.10'.
 *
 * @package     auth_saml
 * @category    string
...
$string['auth_saml_samllib_description'] = 'Ruta de librería para el entorno de SimpleSAMLPHP que Usted quiere usar, por ejemplo:  /var/www/sp/simplesamlphp/lib';
