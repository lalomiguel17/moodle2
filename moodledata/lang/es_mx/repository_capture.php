...
/**
 * Strings for component 'repository_capture', language 'es_mx', version '3.10'.
 *
...
$string['err_record_ffmpeg_exec'] = 'Falló la ejecución de la ruta ffmpeg. Por favor revise la ruta e inténtelo de nuevo.';
$string['err_record_file_not_exists'] = 'La grabación no existe. Probablemente haya un problema con la configuración del servidor. Verifique que la carpeta TEMP sea escribible y que FFMPEG está bien instalado';
$string['err_record_fps_range'] = 'El valor debe estar entre 10 - 60';
$string['err_record_quality_range'] = 'El valor debe estar entre 20 - 100';
$string['pluginname'] = 'Capturar';
$string['pluginname_help'] = 'Grabar un audio o video directamente en Moodle y subirlo al sistema de archivos de Moodle.';
$string['radio_no'] = 'No';
$string['radio_yes'] = 'Si';
