...
/**
 * Strings for component 'local_sanitychecker', language 'es_mx', version '3.10'.
 *
...
$string['local_sanitychecker_impl_legacyfilelink_notification_links'] = 'ID: Enlaces encontrados / ID del Curso :';
