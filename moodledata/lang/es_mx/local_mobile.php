...
/**
 * Strings for component 'local_mobile', language 'es_mx', version '3.10'.
 *
...
$string['cannotcreatetoken'] = 'La generación automática de fichas (tokens) no está disponible para los administradores del sitio (ellos deben de crear una ficha (token) manualmente en el sitio)';
