...
/**
 * Strings for component 'enrol_waitlist', language 'es_mx', version '3.10'.
 *
...
$string['privacy:metadata:user_enrol_waitlist'] = 'Almacena metadatos del usuario en campo userid';
...
<p>Fecha de inicio: {$a->startdate}</p>
