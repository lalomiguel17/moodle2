...
/**
 * Strings for component 'format_menutopic', language 'es_mx', version '3.10'.
 *
...
$string['config_template_topic_title'] = 'Configurar -Descripción de la sección como una plantilla.';
...
$string['jstemplate_help'] = 'Permite definir el código JavaScript que funcionará sobre el menú o la página. Puede ser útil para definir comportamientos adicionales para el menú, o inclusive una estructura del menú diferente a la que tiene por defecto. <p><b>Notas:</b> <ul> <li>El nombre <b>id_menu_box</b> corresponde al identificador div que contiene el menú en HTML creado como listas anidadas, usualmente con las marcas HTML: ul y li.</li> <li>Es posible hacer cambios en los estilos, pero que no se vean inmediatamente en el curso. En este caso, hay que refrescar la página; lo que en muchos navegadores se logra con la combinación de teclas Ctrl + F5.</li> </ul></p>';
...
$string['menuposition_help'] = '<p>Define la posición donde el menú aparecerá en el curso. Las opciones posibles son:
<ul>
   <li><b>No mostrar:</b> no se genera el menú</li>
   <li><b>Izquierda:</b> el menú se genera verticalmente en la columna de bloques izquierda, si existe.</li>
   <li><b>Media:</b> el menú se genera horizontalmente como una barra en medio del curso, sobre la sección</li>
    <li><b>Derecha:</b> el menú se genera verticalmente en la columna de bloques derecha, si existe.</li>
</ul></p>';
...
$string['templatetopic'] = 'Activar Descripción de la sección como una plantilla';
