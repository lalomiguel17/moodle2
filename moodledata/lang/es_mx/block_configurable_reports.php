...
<p>Ejemplo:: SELECT * FROM prefix_course</p>

<p>Usted puede encontrar muchos reportes de SQL aqui: <a href="http://docs.moodle.org/en/ad-hoc_contributed_reports" target="_blank">ad-hoc contributed reports</a></p>

<p>Un diseño actualizado de las tablas de Moodle y sus relaciones interconectada: <a href="https://docs.moodle.org/dev/Database_Schema" target="_blank">Database schema</a></p>

<p>Dado que este bloque soporta los reportes de solicitudes de SQL Personalizados de Tim Hunt, usted puede usar cualquier solicitud.</p>
