...
/**
 * Strings for component 'checkmark', language 'es_mx', version '3.10'.
 *
 * @package     checkmark
 * @category    string
...
$string['eventoverrideprioritychanged'] = 'Prioridad de anulación de marca de verificación catafixiada';
