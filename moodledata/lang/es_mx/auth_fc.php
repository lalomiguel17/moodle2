...
/**
 * Strings for component 'auth_fc', language 'es_mx', version '3.10'.
 *
 * @package     auth_fc
 * @category    string
...
$string['auth_fcdescription'] = 'Este método usa un servidor FirstClass para comprobar si un nombre_de_usuario o contraseña determinados son válidos.';
...
$string['auth_fcuserid'] = 'Identificador (userid) de usuario de la cuenta FirstClass con privilegios de \'Subadministrador\'.';
