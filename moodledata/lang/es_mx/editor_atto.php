...
/**
 * Strings for component 'editor_atto', language 'es_mx', version '3.10'.
 *
 * @package     editor_atto
 * @category    string
...
$string['privacy:metadata:database:atto_autosave'] = 'Borradores de texto del editor que fueron guardados automáticamente.';
...
$string['taskautosavecleanup'] = 'Eliminar borradores auto-grabados caducos';
