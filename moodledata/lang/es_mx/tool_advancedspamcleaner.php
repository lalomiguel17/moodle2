...
/**
 * Strings for component 'tool_advancedspamcleaner', language 'es_mx', version '3.10'.
 *
...
$string['noakismetkey'] = 'Configurar clave API desde página de configuraciones antes de usar esta opción';
...
$string['spamresult'] = 'Por favor tome en cuenta que eliminar un usuario no elimina la entrada spammeada<br /> Resultados de búsqueda de perfiles de usuario conteniendo:';
