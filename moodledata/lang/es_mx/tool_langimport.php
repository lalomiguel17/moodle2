...
$string['langunsupported'] = '<p>Al parecer su servidor no soporta completamente los idiomas siguientes:</p><ul>{$a->missinglocales}</ul><p>En lugar de esto, la locale global ({$a->globallocale}) será usada para formatear ciertas cadenas de caracteres, como por ejemplo las fechas o los números.</p>';
