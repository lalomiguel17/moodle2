...
/**
 * Strings for component 'filter_videoeasy', language 'es_mx', version '3.10'.
 *
...
$string['presets_desc'] = 'Video Fácil viene con algunas pre-configuraciones predeterminadas que Usted puede usar de inmediato, o para ayudarle a iniciar su propia plantilla. Elija una de estas pre-configuraciones aquí, o simplemente cree su propia plantilla desde cero. Usted puede exportar una plantilla como un conjunto al seleccionar la casilla verde de arriba. Usted puede importar un conjunto al arrastrarlo hacia la caja verde.';
...
$string['templatekey_desc'] = 'La ID que identifica esta plantilla. Debe de ser única en el sitio. Los usuarios nunca la ven. Si Usted la cambia Usted necesitará re-asignar la plantilla/reproductor a la extensión de archivo apropiada. Trate de no cambiarla. Usa solamente caracteres alfanuméricos (sin espacios)';
...
$string['templaterequirecss_desc'] = 'Esta es la URLde cualquier archivo CSS necesario. Trate de comenzar con // .';
