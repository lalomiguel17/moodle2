...
/**
 * Strings for component 'theme_slate', language 'es_mx', version '3.10'.
 *
 * @package     theme_slate
 * @category    string
...
$string['choosereadme'] = '<p>pizarra (slate) está basado en el tema slate Bootswatch para Bootstrap</p>';
$string['configtitle'] = 'Pizarra (Slate)';
...
$string['pluginname'] = 'Pizarra (Slate)';
