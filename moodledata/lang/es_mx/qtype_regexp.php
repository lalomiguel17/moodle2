...
/**
 * Strings for component 'qtype_regexp', language 'es_mx', version '3.10'.
 *
...
$string['clicktosubmit'] = 'Complete o corrija su respuesta y elija el botón <strong>Comprobar (Check)</strong> para enviarla.';
