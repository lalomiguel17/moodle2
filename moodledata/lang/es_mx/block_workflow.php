...
/**
 * Strings for component 'block_workflow', language 'es_mx', version '3.10'.
 *
...
$string['emailmessage_help'] = 'Los siguientes reemplazables pueden ser usados en la línea del asunto y en el mensaje:
...
* %%coursestartdate%% - tla fecha de inicio del curso.
* %%courseenddate%% - la fecha cuando termina el curso.
* %%activityopendate%% - para actividades con una fecha de apertura (como Examen) esa fecha.
* %%activityclosedate%% - para actividades con una fecha de cierre (como Examen) esa fecha.
