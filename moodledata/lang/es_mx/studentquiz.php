...
/**
 * Strings for component 'studentquiz', language 'es_mx', version '3.10'.
 *
 * @package     studentquiz
 * @category    string
...
$string['messageprovider:approved'] = 'Notificación de aprobación de pregunta';
$string['messageprovider:changed'] = 'Notificación de cambio en pregunta';
...
$string['messageprovider:hidden'] = 'Notificación de ocultamiento de pregunta';
$string['messageprovider:minecommentdeleted'] = 'Notificación de eliminación de mi comentario';
$string['messageprovider:unhidden'] = 'Notificación de des-ocultamiento de pregunta';
