...
/**
 * Strings for component 'block_community', language 'es_mx', version '3.10'.
 *
...
$string['errorcourselisting'] = 'Por favor tenga en cuenta: Ya no es posible buscar cursos comunitarios en moodle.net. Los cursos que anteriormente estaban compartidos para descargar ahora están disponibles en archive.moodle.net. Vea <a href="https://docs.moodle.org/en/Sunsetting_moodle.net">Sunsetting moodle.net</a> para más detalles.';
