...
/**
 * Strings for component 'theme_cerulean', language 'es_mx', version '3.10'.
 *
...
$string['choosereadme'] = '<p>azul claro (cerulean) está basado en el tema  cerulean Bootswatch para Bootstrap</p>';
$string['configtitle'] = 'Azul claro (Cerulean)';
...
$string['pluginname'] = 'Azul claro (Cerulean)';
