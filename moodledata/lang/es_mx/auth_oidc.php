...
$string['exception_tokenemptyuserid'] = 'El token existente para este usuario no contiene una ID de usuario válida. Por favor póngase en contacto con su administrador.';
