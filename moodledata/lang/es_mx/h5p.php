...
/**
 * Strings for component 'h5p', language 'es_mx', version '3.10'.
 *
 * @package     h5p
 * @category    string
...
$string['date'] = 'Fecha';
$string['deletelibraryconfirm'] = '<p>¿Está seguro de querer eliminar la versión <em>\'{$a->version}\'</em> de la biblioteca <em>\'{$a->name}\'</em>? Esto quitará la librería y todo sus usos..</p><p>This operation can not be undoneEsta operación no puede deshacerse.</p>';
...
$string['missinguploadpermissions'] = 'Tenga en cuenta que las librerías podrían existir en el archivo que Usted subió, pero Usted no tiene permitido subir nuevas librerías. Por favor póngase en contacto con su administrador.';
