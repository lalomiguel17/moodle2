...
/**
 * Strings for component 'block_publishflow', language 'es_mx', version '3.10'.
 *
...
<p>Un curso puede ser directamente desplegado desde una Fábrica a un Área de Aprendizaje para fines de pruebas.</p>

<p>El despliegue automáticamente se dirige a la categoría de desplieqgue predeterminada definida en las configuraciones globales.</p>';
...
$string['notargets_help'] = '<h2>Sin blancos para desplegar</h2>

<p>El sistema de desplegado del curso no encontró ningún candidato en donde instalar una sesión de trabajo: Las siguientes situaciones deben investigarse:</p>
<ul>
<li>Usted no tiene capacidades para desplegar en ninguna de las plataformas de entrenamiento disponibles.</li>
<li>Algunos problemas técnicos impiden físicamente conectarse a los nodos de entrenamiento de su responsabilidad.</li>
<li>Este curso no puede desplegarse por estar mal referenciado.</li> <ul>
...
<p>Al lanzar la operación de re-conversión, Usted copiará la estructura y contenido de este curso tal como estuvo almacenada en el último respaldo guardado en los archivos del curso.</p>

<p>El respaldo usado para reconvertir IGNORA cualquier información relacionada con usuarios y datos del curso, las actividades, recursos y bloques siendo reproducidas con las mismas configuraciones que el original.</p>

<p>La unidad re-convertida estará disponible en una categoría predefinida.</p>';
