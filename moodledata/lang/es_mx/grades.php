...
/**
 * Strings for component 'grades', language 'es_mx', version '3.10'.
 *
 * @package     grades
 * @category    string
...
$string['averagesdecimalpoints_help'] = 'Esta configuración determina el número de decimales a mostrar para cada promedio, o si es que la configuración general de decimales para la categoría o el ítem de calificación es usada (heredar).';
...
Por ejemplo, si esta opción se  configura a \'Si\', el cambiar la calificación máxima en un ítem de 10 a 20 causaría que una calificación de 6/10 (60%) sea re-escalada a 12/20 (60%). Con esta opción configurada a \'No\', la calificación permanecerá sin cambios y necesitaría ajuste manual de los ítems de calificación para asegurar puntuaciones correctas.';
...
$string['rangesdecimalpoints_help'] = 'Esta configuración determina el número de decimales que se visualizarán para cada rango o si es que es usado el número general de decimales para la categoría o el ítem de calificación (heredar).';
