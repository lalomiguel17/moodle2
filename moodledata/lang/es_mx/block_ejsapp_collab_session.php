...
/**
 * Strings for component 'block_ejsapp_collab_session', language 'es_mx', version '3.10'.
 *
...
$string['block_title'] = 'Sesión colaborativa EJSApp';
$string['cantJoinSessionErr1'] = 'Error: Usted ya está participando en una sesión colaborativa. Cierre su sesión de colaboración activa antes de crear una nueva.';
$string['cantJoinSessionErr2'] = 'Error: Ahorita Usted no tiene invitaciones activas a ninguna sesión colaborativa.';
$string['close1'] = 'La sesión colaborativa con el laboratorio';
$string['close2'] = 'ha sido cerrada.';
$string['closeMasSessBut'] = 'Cerrar mi sesión activa';
$string['closeStudSessBut'] = 'Abandonar esta sesión';
$string['collaborative_port'] = 'Puerto para sesión colaborativa';
$string['collaborative_port_description'] = 'Puerto usado para establecer comunicación para las sesiones colaborativas cuando no se usa Sarlab';
$string['createBut'] = 'Crear sesión colaborativa';
$string['default_options_config'] = 'Configurar las opciones de comunicación predeterminadas (sin usar Sarlab) para sesiones colaborativas';
$string['ejsapp_collab_session:addinstance'] = 'Añadir un nuevo bloque EJSApp para sesiones colaborativas';
$string['ejsapp_collab_session:myaddinstance'] = 'Añadir un nuevo bloque EJSApp para sesiones colaborativas a Mi hogar';
$string['goToMasSessBut'] = 'Ir a mi sesión activa';
$string['goToStudSessBut'] = 'Listar todas mis invitaciones activas';
$string['goodbyeStudent'] = 'Usted ha dejado la sesión colaborativa';
$string['invitationMsg1'] = 'le ha invitado a Usted a una sesión colaborativa con este lab:';
...
$string['sarlab_header'] = 'Configurar Sarlab para esta instancia de bloque';
$string['sarlab_header_config'] = 'Configurar Sarlab para todas las instancias de bloque';
...
$string['sarlab_port'] = 'Puerto(s) de comunicación Sarlab';
...
$string['selectInvitation'] = 'Seleccione una de las siguientes invitaciones:';
$string['selectLabBut'] = 'Seleccionar un laboratorio';
$string['start_collaborative_session:view'] = 'Ver bloque para Sesión Colaborativa';
$string['use_sarlab'] = '¿Usar Sarlab en sesiones colaborativas?';
$string['using_sarlab'] = '¿Permitir usar Sarlab en sesiones colaborativas?';
$string['using_sarlab_help'] = 'Esta opción habilita el usar Sarlab para enrutar conexiones en sesiones colaborativas.';
