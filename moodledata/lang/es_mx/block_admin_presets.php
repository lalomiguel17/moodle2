...
/**
 * Strings for component 'block_admin_presets', language 'es_mx', version '3.10'.
 *
...
$string['deletepreviouslyapplied'] = 'Esta preconfiguración había sido aplicada previamente. Si Usted la elimina, no podrá regresar al estado anterior.';
...
$string['markedasadvanced'] = 'marcadas como avanzadas';
$string['markedasforced'] = 'marcadas como forzadas';
$string['markedaslocked'] = 'marcadas como bloqueadas';
$string['markedasnonadvanced'] = 'marcadas como no-avanzadas';
$string['markedasnonforced'] = 'marcadas como no-forzadas';
$string['markedasnonlocked'] = 'marcadas como no-bloqueadas';
