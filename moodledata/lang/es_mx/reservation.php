...
/**
 * Strings for component 'reservation', language 'es_mx', version '3.10'.
 *
 * @package     reservation
 * @category    string
...
$string['cancellersmail'] = 'Usted está cancelado de \'{$a->reservation}\'. reservación';
$string['cancellersmailhtml'] = 'Usted está cancelado de <em>{$a->reservation}</em>. reservación';
...
$string['crontask'] = 'Enviar reservación y solicitar correos de calificación';
...
Usted puede verla aquí:
 ...
 {$a->url}';
$string['gradedmailhtml'] = '{$a->teacher} ha publicado retroalimentación sobre su reservación  \'<i>{$a->reservation}</i>\'<br /><br />
Usted puede verla <a href=\\"{$a->url}\\">aquí</a>.';
...
$string['noreservations'] = 'Sin reservación para mostrar';
$string['note'] = 'Nota';
$string['noteachers'] = 'Sin profesores disponibles';
$string['notequal'] = 'no es igual a';
$string['noterequired'] = 'Nota requerida, por favor ingrésela aquí antes de reservar.';
$string['notgraded'] = 'No calificado';
$string['notifies'] = 'Notificaciones enviadas';
$string['notifycancellers'] = 'Notificar a canceladores cuando hagan una cancelación exitosa de reservación';
$string['notifygrades'] = 'Notificar reservación calificada a estudiantes';
$string['notifyoverbookers'] = 'Notificar a estudiantes que hayan sobre-reservado cuando se vuelvan reservados regulares.';
$string['notifyreservers'] = 'Notificar a reservadores cuando ellos hagan una solicitud exitosa de reservación';
...
$string['notreserved'] = 'No reservado';
...
$string['overbookonly'] = 'Solamente hay asientos sobre-reservados disponibles';
...
$string['reservation:manage'] = 'Puede gestionar reservación';
...
$string['reservation:view'] = 'Puede ver reservación';
...
$string['reserversmail'] = 'Usted está reservado a \'{$a->reservation}\' reservación.';
$string['reserversmailhtml'] = 'Usted está reservado a <em>{$a->reservation}</em> reservación.';
...
$string['status'] = 'Estado de reservación';
