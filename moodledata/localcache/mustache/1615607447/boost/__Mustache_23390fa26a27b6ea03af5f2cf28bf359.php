...
class __Mustache_23390fa26a27b6ea03af5f2cf28bf359 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'block5978bc1395901ef1af35222a82aae600'),
            ));
...
';
    ...
    public function block5978bc1395901ef1af35222a82aae600($context)
    {
        $indent = $buffer = '';
...
';
        $buffer .= $indent . '            <div class="closewidget bg-light border-bottom text-right">
';
        $buffer .= $indent . '                <a class="text-dark" data-action="closedrawer" href="#">
';
        $buffer .= $indent . '                     ';
        // 'pix' section
