...
class __Mustache_98b1fbddf2faa4fb495f84386885c180 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionBadd10255df4ca9d4ca10db3136b2ce8($context, $indent, $value);
        $buffer .= $indent . '        ';
...
';
    ...
    private function sectionBadd10255df4ca9d4ca10db3136b2ce8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
